...
public class Home extends JFrame{
    ...
    public Home(String username) {
        ...
        l1.setForeground(Color.BLACK); // Bold Black Text
        l1.setFont(new Font("SansSerif", Font.BOLD, 55)); // Professional Bold Font
        l1.setBounds(50, 50, 1100, 100); // Ensures full visibility
